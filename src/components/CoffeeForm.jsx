...
export default function CoffeeForm(props) {
    ...
    async function handleSubmitForm() {
        ...
        // define a guard clause that only submits the form if is completed
        if (!selectedCoffee) {
            return
        }
        ...
        try {
            ...
            const timeToSubtract = (hour * 60 * 60 * 1000) + (min * 60 * 1000) // converting to milliseconds
            ...
            const userRef = doc(database, 'users', globalUser.uid)
